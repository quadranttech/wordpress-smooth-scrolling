...
function footer_callback_to_add_script() {
    ...
    $script_data = '<script>jQuery(\'body\').append( \'<div class="pageTop" style="'. $style_str .'"><img src="'.$page_scroll_plugin_url.'/images/arrow.png"></div>\' );</script>';
...
function wp_smooth_scroll_config_menu() {
	add_menu_page(
		__("WP Smooth Scroll Options", WP_SMOOTH_SCROLL_CONFIG_DOMAIN),
		__("WP Smooth Scroll", WP_SMOOTH_SCROLL_CONFIG_DOMAIN),
